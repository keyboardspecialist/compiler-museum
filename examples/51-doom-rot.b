// 51-doom-rot: 50 + sprite depth sort + monster rotation frames.
//
// What's new vs 50:
//   - Monsters now look up 8 rotation frames (digit 1..8) based on the
//     viewer's bearing in the monster's local frame.  Sprite name is
//     built per frame as base + 'A' + digit.
//   - draw_sprites() collects visible sprites with their depth (cay),
//     insertion-sorts back-to-front, then renders.  Eliminates the
//     order-dependent overdraw artifacts in 48-50.
//
