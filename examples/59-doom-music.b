// 59-doom-music: 58 + background music playback.
//
// What's new vs 58:
//   - Upload any .ogg / .mp3 / .wav / .flac alongside your WAD via
//     the Assets tab.
//   - On the first key press (browser autoplay gate) the first
//     audio-extension asset is started via Sys_playmusic with loop.
//
...
// Scan Sys_assetlist for the first audio asset; start it looping via
// Sys_playmusic. Called from the main loop once a user input has
// satisfied the browser's autoplay gate.
